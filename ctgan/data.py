...
def post_processing(synthetic_data):
    ...
    synthetic_data.to_csv('data/raw_synthetic_data.csv', index=False)
    final_data.to_csv('data/fianl_synthetic_data.csv', index=False)